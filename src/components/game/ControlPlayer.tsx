    ...
    return (
        <li className={`${color} select-none rounded-2xl w-5/6 h-16 p-3 flex justify-between items-center gap-2 mx-auto relative`}>
            ...
            <div className='flex gap-1'>
                ...
                <button onClick={doctor} disabled={game.phase !== Phase.Night || !player.isAlive} className={`transition-opacity disabled:opacity-0 ${player.id === game.choose.doctor ? 'bg-black rounded-full text-white' : ''}`}><MedicationIcon/></button>
