    ...
    reducers: {
        ...
        startGame: (state) => {
            ...
            switch (state.playersCount) {
                ...
                case 7: {
                    roles = [Role.Don, Role.Doctor, Role.Peace, Role.Peace, Role.Peace, Role.Peace, Role.Peace]
                    break
                }
                case 8: {
                ...
                case 10: {
                    roles = [Role.Mafia, Role.Mafia, Role.Don, Role.Doctor, Role.Sheriff, Role.Peace, Role.Peace, Role.Peace, Role.Peace, Role.Peace]
                    break
                }
                case 11: {
